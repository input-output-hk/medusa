...
export default class CommitList extends Component {
  ...
  render () {
    if (this.props.config.display.showSidebar) {
      ...
      const selector = <div className="select mr-3"><small>{this.props.showing}</small>&nbsp;&nbsp;<select className="" value={this.state.value} onChange={this.handleChange}><option value="5">5</option><option value="10">10</option><option value="20">20</option><option value="50">50</option><option value="100">100</option><option value="500">500</option></select></div>
